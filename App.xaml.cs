...
namespace ClientSide
{
    ...
    public partial class App : Application
    {
        ...
        public static void ConfigureServices(HostBuilderContext host, IServiceCollection services)
        {
            ...
            services.AddTransient<IPalindromeValidator, PalindromeValidatorFromServer>(provider =>
                new PalindromeValidatorFromServer(provider.GetRequiredService<HttpClient>(), serverUrl));
        }
    }
